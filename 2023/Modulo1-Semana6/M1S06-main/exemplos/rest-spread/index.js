...
const somaTodos = (inicial, ...numeros) =>
  console.log(numeros.reduce((acumulador, itemAtual) => acumulador + itemAtual, inicial));
  // console.log(numeros.reduce((acumulador[4], itemAtual[2]) => acumulador[4] + itemAtual[2], inicial[4]));
  // console.log(numeros.reduce((acumulador[6], itemAtual[3]) => acumulador[6] + itemAtual[3], inicial[4]));
  // console.log(numeros.reduce((acumulador[9], itemAtual[1]) => acumulador[9] + itemAtual[1], inicial[4]));
  // console.log(numeros.reduce((acumulador[10], itemAtual[8]) => acumulador[10] + itemAtual[8], inicial[4]));
...
const valoresIndefinidos = (...valores) => {
  let apenasNumeros = valores.filter((item) => typeof item == "number")
  console.log(apenasNumeros.reduce((acum, n) => acum + n, 0));
}

valoresIndefinidos(5, 9, "dados", true, 40, 17, "vinte e três");


const qtdArgumentos = (...valores) => {
  console.log(valores.length)
}

qtdArgumentos(5, 9, "dados", true, 40, 17, "vinte e três");
...
const computadorUpGrade = {
  ...computador, 
  processador: "Core i7",
  storage: "1TB"
}

console.log(computadorUpGrade)